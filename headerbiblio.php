...
<head>
    ...
    <script src="https://kit.fontawesome.com/65cf8a79f5.js" crossorigin="anonymous"></script>
    <!-- Favicons -->
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false"><i
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false"><i
                            class="fa-solid fa-person"></i> gestion des auteur</a>
                    <div class="dropdown-menu">
